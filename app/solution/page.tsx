...
const translations: Translations = {
  // Hero Section
  badge: { vi: 'GIẢI PHÁP KASPOS', en: 'KASPOS SOLUTION', ko: 'KASPOS 솔루션', zh: 'KASPOS解决方案', ja: 'KASPOSソリューション' },
...
export default function SolutionPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Hero Section - KASPOS với màu xanh dương tím */}
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex items-center">
        {/* Enhanced Background with Blue-Purple Theme */}
        <div className="absolute inset-0 bg-linear-to-br from-blue-50 via-purple-50 to-violet-50 -z-10" />
        <div className="absolute inset-0 bg-linear-to-tr from-transparent via-blue-100/30 to-transparent -z-10 animate-gradient" />
        
        {/* Animated Orbs with Parallax Effect - Blue-Purple Theme */}
        <div 
          className="absolute top-20 -left-20 w-[500px] h-[500px] bg-linear-to-br from-blue-400/30 to-purple-400/20 rounded-full blur-3xl -z-10 animate-float"
          style={{ transform: `translateY(${scrollY * 0.3}px)` }}
        />
        <div 
          className="absolute bottom-20 right-0 w-[400px] h-[400px] bg-linear-to-br from-purple-400/20 to-violet-400/20 rounded-full blur-3xl -z-10 animate-float" 
          style={{animationDelay: '1s', transform: `translateY(${scrollY * 0.2}px)`}} 
        />
        <div 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-linear-to-br from-violet-400/20 to-blue-400/20 rounded-full blur-3xl -z-10 animate-float" 
        ...
        <div className={`max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          {/* Badge - Blue-Purple Theme with Glow */}
          <div className="inline-flex items-center gap-3 glass-effect bg-linear-to-r from-blue-500/90 to-purple-500/90 text-blue-500 px-8 py-4 rounded-full text-lg font-bold mb-8 shadow-2xl animate-fade-in-scale border border-white/20">
            <Leaf className="w-6 h-6 animate-bounce-subtle" />
            <span className="uppercase tracking-wide text-xl">{t('badge')}</span>
            <Sparkles className="w-6 h-6 animate-pulse" />
          </div>

          {/* Main Title - Blue-Purple Gradient */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight">
            <span className="inline-block animate-slide-up bg-linear-to-r from-blue-600 via-purple-600 to-violet-600 bg-clip-text text-transparent animate-gradient text-shadow-glow">
              {t('heroTitle')}
            </span>
          </h1>
          ...
          {/* Features Grid - Enhanced with 3D Effects and Blue-Purple Theme */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto mb-16 animate-fade-in-up stagger-2">
            <div className="group relative glass-effect bg-white/90 rounded-3xl p-6 border-2 border-blue-200 hover:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 card-3d overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-400/10 rounded-full blur-xl transform group-hover:scale-150 transition-transform duration-500" />
              <div className="relative z-10">
                <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group relative glass-effect bg-white/90 rounded-3xl p-6 border-2 border-purple-200 hover:border-purple-400 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 card-3d overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-purple-400/10 rounded-full blur-xl transform group-hover:scale-150 transition-transform duration-500" />
              <div className="relative z-10">
                <div className="w-16 h-16 bg-linear-to-br from-purple-500 to-violet-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group relative glass-effect bg-white/90 rounded-3xl p-6 border-2 border-violet-200 hover:border-violet-400 hover:shadow-2xl hover:shadow-violet-500/20 transition-all duration-300 card-3d overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-violet-400/10 rounded-full blur-xl transform group-hover:scale-150 transition-transform duration-500" />
              <div className="relative z-10">
                <div className="w-16 h-16 bg-linear-to-br from-violet-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="glass-effect bg-linear-to-br from-white/90 to-blue-50/30 rounded-3xl p-10 border-2 border-blue-200 shadow-2xl max-w-5xl mx-auto animate-fade-in-up stagger-3 hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <p className="text-2xl md:text-3xl font-bold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{t('valueTitle')}</p>
            </div>
          ...
          <div className="mt-16 animate-bounce-subtle opacity-60">
            <div className="w-6 h-10 border-2 border-blue-500 rounded-full mx-auto relative">
              <div className="w-1.5 h-3 bg-blue-500 rounded-full absolute top-2 left-1/2 transform -translate-x-1/2 animate-pulse" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-blue-50/50 via-purple-50/30 to-white relative overflow-hidden">
        {/* Decorative Elements */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-in-up">
            <div className="inline-flex items-center gap-2 glass-effect bg-linear-to-r from-blue-500 to-purple-500 px-6 py-3 rounded-full text-xl font-bold mb-6 text-blue-500 shadow-lg border border-white/20">
              <Monitor className="w-7 h-7 animate-bounce-subtle" />
              <span className="uppercase tracking-wide">{t('deviceBadge')}</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-600 via-purple-600 to-violet-600 bg-clip-text text-transparent mb-6 pb-1 animate-gradient text-shadow-glow">
              {t('deviceTitle')}
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Device 1 */}
            <div className="group glass-effect bg-white/90 rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 card-3d animate-fade-in-up stagger-1">
              <div className="relative">
                <div className="flex items-center justify-center mb-6 h-32">
                  <div className="relative">
                    <Smartphone className="w-24 h-24 text-blue-600 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300" strokeWidth={1.5} />
                    <div className="absolute inset-0 bg-blue-400/20 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500" />
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-bold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-3 text-center">{t('device1')}</h3>
            ...
            {/* Device 2 */}
            <div className="group glass-effect bg-white/90 rounded-3xl p-8 border-2 border-purple-200 hover:border-purple-400 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 card-3d animate-fade-in-up stagger-2">
              <div className="relative">
                <div className="flex items-center justify-center mb-6 h-32">
                  <div className="relative">
                    <Tablet className="w-24 h-24 text-purple-600 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300" strokeWidth={1.5} />
                    <div className="absolute inset-0 bg-purple-400/20 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500" />
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-bold bg-linear-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-3 text-center">{t('device2')}</h3>
              <p className="text-gray-600 text-center whitespace-pre-line text-sm leading-relaxed">{t('device2Desc')}</p>
            </div>

            {/* Device 3 */}
            <div className="group glass-effect bg-white/90 rounded-3xl p-8 border-2 border-violet-200 hover:border-violet-400 hover:shadow-2xl hover:shadow-violet-500/20 transition-all duration-500 card-3d animate-fade-in-up stagger-3">
              <div className="relative">
                <div className="flex items-center justify-center mb-6 h-32">
                  <div className="relative">
                    <Monitor className="w-24 h-24 text-violet-600 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300" strokeWidth={1.5} />
                    <div className="absolute inset-0 bg-violet-400/20 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500" />
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-bold bg-linear-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent mb-3 text-center">{t('device3')}</h3>
              <p className="text-gray-600 text-center whitespace-pre-line text-sm leading-relaxed">{t('device3Desc')}</p>
              <div className="mt-4 flex justify-center">
                <ArrowRight className="w-5 h-5 text-violet-600 group-hover:translate-x-2 transition-transform duration-300" />
              </div>
            </div>

            {/* Device 4 */}
            <div className="group glass-effect bg-white/90 rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 card-3d animate-fade-in-up stagger-4">
              <div className="relative">
                <div className="flex items-center justify-center mb-6 h-32">
                  <div className="relative">
                    <Monitor className="w-20 h-20 text-blue-600 mr-2 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
                    <Tablet className="w-16 h-16 text-purple-600 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
                    <div className="absolute inset-0 bg-blue-400/20 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500" />
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-bold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-3 text-center">{t('device4')}</h3>
